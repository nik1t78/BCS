...
| Файл | Описание | Время |
|------|----------|-------|
| **QUICK_START_WINDOWS.md** | Быстрый запуск на Windows | 5 мин |
| **LOCAL_RUN_WINDOWS.md** | Подробная инструкция для Windows | 15 мин |
| **AUTOSTART_GUIDE.md** | Настройка автозапуска сервера | 5 мин |
| **HOW_TO_SHARE.md** | Как поделиться с командой | 5 мин |
| **LOCAL_DEPLOYMENT.md** | Развертывание для команды | 20 мин |
...
## 🔐 БЕЗОПАСНОСТЬ И СИСТЕМА РОЛЕЙ

### Система временных паролей

**Важно:** Пароли администратора и модератора **НЕ хранятся в коде**!
...
3. Пароль отображается на странице входа в жёлтом блоке
4. После первого входа **обязательна смена пароля**
...
# 3. На странице входа увидите жёлтый блок с временным паролем:
#    Логин: admin
#    Пароль: tempXXXXXXXX
...
📖 **Подробная документация**: [PASSWORD_SECURITY.md](./PASSWORD_SECURITY.md)
...
- ✅ **Шаблоны конференций** - создание и управление
...
📖 **Подробная документация**: [ROLES_AND_PERMISSIONS.md](./ROLES_AND_PERMISSIONS.md)
...
#### Хранение паролей
```javascript
// Пароли хранятся только в localStorage
// НЕ захардкожены в коде
